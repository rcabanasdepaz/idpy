...
upot = build_potential_table(KIND.UTILITY, [[20,30, 10],[0,1,-4]], variables=["x","d2"])
px_d1 = build_potential_table(KIND.PROBABILITY, [[0.3,0.5, 0.4], [0.7,0.5, 0.6]], variables=["x", "d2"])
pa_d2 = build_potential_table(KIND.PROBABILITY, [[0.4, 0.2], [0.3, 0.1], [0.3, 0.7]], variables=["a", "d1"])
